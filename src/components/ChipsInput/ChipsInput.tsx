...
const ChipsInput = <Option extends ChipsInputOption>(props: ChipsInputProps<Option>) => {
  ...
  return (
    <FormField
      ...
      scopedClass={classNames('ChipsInput', `ChipsInput--sizeY-${sizeY}`, {
      ...
      style={style}
    >
      <div scopedClass="ChipsInput__container">
        ...
        <div scopedClass="ChipsInput__input-container">
          <input ref={getRef}
            value={fieldValue}
            autoCapitalize="none"
            autoComplete="off"
