...
class DatePicker extends Component<DatePickerProps, DatePickerState> {
  ...
  customView() {
    ...
    return (
      <div scopedClass="DatePicker" {...restProps}>
        <div scopedClass="DatePicker__container">
          <div scopedClass="DatePicker__day">
            <CustomSelect
              name="day"
              value={day}
          ...
          <div scopedClass="DatePicker__month">
            <CustomSelect
              name="month"
              value={month}
          ...
          <div scopedClass="DatePicker__year">
            <CustomSelect
              name="year"
              value={year}
