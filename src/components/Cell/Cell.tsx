...
export const Cell: FC<CellProps> = (props: CellProps) => {
    ...
    <SimpleCell
      ...
      before={
        <Fragment>
          ...
          {selectable && (
            <Fragment>
              <input type="checkbox" scopedClass="Cell__checkbox" name={name} onChange={onChange} defaultChecked={defaultChecked} checked={checked} />
              <div scopedClass="Cell__marker"><Icon16Done /></div>
            </Fragment>
          )}
          {before}
        </Fragment>
  ...
  return (
    <div
      scopedClass={classNames(getClassName('Cell', platform), {
