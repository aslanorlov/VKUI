...
class NativeSelect extends React.Component<NativeSelectProps, SelectState> {
  ...
  render() {
    ...
    return (
      <FormField
        Component="label"
        scopedClass={classNames(getClassName('Select', platform), {
      ...
      >
        ...
        <TypographyComponent weight="regular" scopedClass="Select__container">
          <div scopedClass="Select__title">{this.state.title}</div>
