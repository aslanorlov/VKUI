...
class Slider extends Component<SliderProps, SliderState> {
  ...
  render() {
    ...
    return (
      ...
      >
        <Touch getRootRef={this.getRef} onStart={this.onStart} onMoveX={this.onMoveX} scopedClass="Slider__in">
          <div scopedClass="Slider__dragger" style={{ width: `${this.state.percentPosition}%` }}>
            <span
              scopedClass={classNames('Slider__thumb', 'Slider__thumb--end')}
            />
          </div>
        </Touch>
      </div>
