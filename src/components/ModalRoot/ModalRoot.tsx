    ...
    return (
      <TouchRootContext.Provider value={true}>
        <ModalRootContext.Provider value={this.modalRootContext}>
          <Touch
            scopedClass={classNames(getClassName('ModalRoot', this.props.platform), {
          ...
          >
            <div
              scopedClass="ModalRoot__mask"
              onClick={this.triggerActiveModalClose}
              ref={this.maskElementRef}
            />
            <div scopedClass="ModalRoot__viewport" ref={this.viewportRef}>
              {this.getModals().map((Modal) => {
                ...
                return (
                  <div
                    ...
                    scopedClass={classNames('ModalRoot__modal', {
