              ...
              {(insideTouchRoot: boolean) => {
                ...
                return (
                  <RootComponent
                    ...
                    <span scopedClass="Tappable__waves">
                      {Object.keys(clicks).map((k: string) => {
                        return (
                          <span scopedClass="Tappable__wave" style={{ top: clicks[k].y, left: clicks[k].x }} key={k} />
                        );
                      })}
                    </span>
                    }
                    {hasHover && <span scopedClass="Tappable__hoverShadow" />}
                  </RootComponent>
                );
              }}
            </TouchRootContext.Consumer>
