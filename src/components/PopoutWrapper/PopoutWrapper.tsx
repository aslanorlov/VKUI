...
class PopoutWrapper extends Component<PopoutWrapperProps & DOMProps, PopoutWrapperState> {
  ...
  render() {
    ...
    return (
      <div
        {...restProps}
        scopedClass={classNames(baseClassNames, `PopoutWrapper--v-${alignY}`, `PopoutWrapper--h-${alignX}`, {
        ...
        ref={this.elRef}
      >
        <div scopedClass="PopoutWrapper__container">
          <div
            scopedClass="PopoutWrapper__overlay"
            onClick={onClick} />
          <div scopedClass="PopoutWrapper__content">
            {children}
          </div>
        </div>
      </div>
