  ...
  render() {
    ...
    return (
      <AppRootPortal>
        <div
          {...restProps}
          scopedClass={classNames(getClassName('Snackbar', platform), `Snackbar--l-${resolvedLayout}`, {
        ...
        >
          <Touch
            scopedClass="Snackbar__in"
            getRootRef={this.getInnerRef}
            onStart={this.onTouchStart}
            onMoveX={this.onTouchMoveX}
            onEnd={this.onTouchEnd}
          >
            <div scopedClass="Snackbar__body" ref={this.bodyElRef}>
              {before &&
              <div scopedClass="Snackbar__before">
                {before}
              </div>}

              <div scopedClass="Snackbar__content">
                <Text weight="regular" scopedClass="Snackbar__content-text">{children}</Text>

                {action &&
                <Button align="left" hasHover={false} mode="tertiary" size="s" scopedClass="Snackbar__action" onClick={this.onActionClick}>
                  {action}
                </Button>}
              </div>

              {after &&
              <div scopedClass="Snackbar__after">
                {after}
              </div>}
            </div>
          </Touch>
