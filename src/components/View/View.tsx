  ...
  render() {
    ...
    return (
      <Touch
        Component="section"
        {...restProps}
        scopedClass={classNames(getClassName('View', platform), modifiers)}
        onMoveX={this.onMoveX}
        onEnd={this.onEnd}
      >
        <div scopedClass="View__panels">
          {panels.map((panel: React.ReactElement) => {
            const panelId = panel.props.id;

            return (
              <div
                scopedClass={classNames('View__panel', {
                ...
                key={panelId}
              >
                <div scopedClass="View__panel-in">
                  {panel}
                </div>
              </div>
            );
        ...
        <AppRootPortal>
          {hasPopout && <div scopedClass="View__popout">{popout}</div>}
          {hasModal && <div scopedClass="View__modal">{modal}</div>}
        </AppRootPortal>
      </Touch>
    );
  }
