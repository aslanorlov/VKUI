...
const HorizontalScroll: FC<HorizontalScrollProps> = (props: HorizontalScrollProps) => {
  ...
  return (
    <div {...restProps} scopedClass={getClassName('HorizontalScroll', platform)}>
      ...
      <div scopedClass="HorizontalScroll__in" ref={scrollerRef}>
        <div scopedClass="HorizontalScroll__in-wrapper">
          {children}
        </div>
      </div>
    </div>
