...
const Group: FC<GroupProps> = (props) => {
  ...
  return (
    <section
      {...restProps}
      ref={getRootRef}
      scopedClass={classNames(baseClassNames, `Group--sizeX-${sizeX}`, `Group--${computedMode}`)}
    >
      <div scopedClass="Group__inner">
        {header}
        {children}
        {hasReactNode(description) &&
        <div scopedClass="Group__description">
      ...
      {separator !== 'hide' &&
        <Separator
          scopedClass={classNames('Group__separator', {
