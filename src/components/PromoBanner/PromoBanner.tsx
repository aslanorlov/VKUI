...
const PromoBanner = (props: PromoBannerProps) => {
  ...
  return (
    <div scopedClass={getClassName('PromoBanner', platform)} {...restProps}>
      <div scopedClass="PromoBanner__head">
        <Caption weight="regular" level="1" scopedClass="PromoBanner__label">{bannerData.advertisingLabel || 'Advertisement'}</Caption>
        {ageRestrictions != null && <Caption weight="regular" level="1" scopedClass="PromoBanner__age">{ageRestrictions}+</Caption>}

        {!props.isCloseButtonHidden &&
          <div scopedClass="PromoBanner__close" onClick={props.onClose}>
            <Icon24Dismiss />
          </div>
        }
      </div>
      ...
      {currentPixel.length > 0 &&
        <div scopedClass="PromoBanner__pixels">
