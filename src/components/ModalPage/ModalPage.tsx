...
const ModalPage: FC<ModalPageProps> = (props: ModalPageProps) => {
  ...
  return (
    <div
      {...restProps}
      scopedClass={classNames(getClassName('ModalPage', platform), `ModalPage--sizeX-${sizeX}`, {
        'ModalPage--desktop': isDesktop,
      })}
    >
      <div scopedClass="ModalPage__in-wrap" ref={refs.innerElement}>
        <div scopedClass="ModalPage__in">
          <div scopedClass="ModalPage__header" ref={refs.headerElement}>
            {header}
          </div>

          <div scopedClass="ModalPage__content-wrap">
            <div scopedClass="ModalPage__content" ref={multiRef<HTMLDivElement>(refs.contentElement, getModalContentRef)}>
              <div scopedClass="ModalPage__content-in">
                {children}
              </div>
            </div>
          </div>
